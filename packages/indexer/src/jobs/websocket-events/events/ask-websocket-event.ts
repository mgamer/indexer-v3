...
export class AskWebsocketEvent {
  public static async triggerEvent(data: AskWebsocketEventInfo) {
    try {
      ...
      logger.error("ask-updated-websocket-event", `Error triggering event. ${e}`);
    }
  }
}
