...
import { SeaportV13 } from "@reservoir0x/sdk";
...
export const orderCancelled: EventData = {
  kind: "seaport",
  subKind: "seaport-v1.3-order-cancelled",
  addresses: { [SeaportV13.Addresses.Exchange[config.chainId]?.toLowerCase()]: true },
...
export const orderFulfilled: EventData = {
  kind: "seaport",
  subKind: "seaport-v1.3-order-filled",
  addresses: { [SeaportV13.Addresses.Exchange[config.chainId]?.toLowerCase()]: true },
...
export const counterIncremented: EventData = {
  kind: "seaport",
  subKind: "seaport-v1.3-counter-incremented",
  addresses: { [SeaportV13.Addresses.Exchange[config.chainId]?.toLowerCase()]: true },
