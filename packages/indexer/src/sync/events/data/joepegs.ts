...
import { Joepegs } from "@reservoir0x/sdk";
...
export const takerAsk: EventData = {
  kind: "joepegs",
  subKind: "joepegs-taker-ask",
  addresses: { [Joepegs.Addresses.Exchange[config.chainId]?.toLowerCase()]: true },
