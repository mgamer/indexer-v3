...
import * as seaportV13 from "@/events-sync/data/seaport-v1.3";
...
export type EventSubKind =
  ...
  | "seaport-v1.3-order-cancelled"
  | "seaport-v1.3-order-filled"
  | "seaport-v1.3-counter-incremented"
  | "rarible-match"
  | "rarible-cancel"
  | "rarible-buy-v1"
  | "rarible-match-v2"
...
const allEventData = [
  ...
  seaportV13.counterIncremented,
  seaportV13.orderCancelled,
  seaportV13.orderFulfilled,
