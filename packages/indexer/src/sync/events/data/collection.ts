...
export const tokenDeposit: EventData = {
  kind: "collection",
  subKind: "collection-token-deposit",
...
export const tokenWithdrawal: EventData = {
  kind: "collection",
  subKind: "collection-token-withdrawal",
...
export const nftDeposit: EventData = {
  kind: "collection",
  subKind: "collection-nft-deposit",
...
export const nftWithdrawal: EventData = {
  kind: "collection",
  subKind: "collection-nft-withdrawal",
...
export const accruedTradeFeeWithdrawal: EventData = {
  kind: "collection",
  subKind: "collection-accrued-trade-fee-withdrawal",
...
export const acceptsTokenIds: EventData = {
  kind: "collection",
  subKind: "collection-accepts-token-ids",
...
export const swapNftInPool: EventData = {
  kind: "collection",
  subKind: "collection-swap-nft-in-pool",
...
export const swapNftOutPool: EventData = {
  kind: "collection",
  subKind: "collection-swap-nft-out-pool",
...
export const spotPriceUpdate: EventData = {
  kind: "collection",
  subKind: "collection-spot-price-update",
...
export const deltaUpdate: EventData = {
  kind: "collection",
  subKind: "collection-delta-update",
...
export const propsUpdate: EventData = {
  kind: "collection",
  subKind: "collection-props-update",
...
export const stateUpdate: EventData = {
  kind: "collection",
  subKind: "collection-state-update",
...
export const royaltyNumeratorUpdate: EventData = {
  kind: "collection",
  subKind: "collection-royalty-numerator-update",
...
export const royaltyRecipientFallbackUpdate: EventData = {
  kind: "collection",
  subKind: "collection-royalty-recipient-fallback-update",
...
export const externalFilterSet: EventData = {
  kind: "collection",
  subKind: "collection-external-filter-set",
...
export const protocolFeeMultiplierUpdate: EventData = {
  kind: "collection",
  subKind: "collection-protocol-fee-multiplier-update",
...
export const carryFeeMultiplierUpdate: EventData = {
  kind: "collection",
  subKind: "collection-carry-fee-multiplier-update",
...
export const assetRecipientChange: EventData = {
  kind: "collection",
  subKind: "collection-asset-recipient-change",
