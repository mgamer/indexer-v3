      ...
      owners: Joi.array().items(
        Joi.object({
          ...
          ownership: Joi.object({
            ...
            floorAskPrice: JoiPrice.allow(null).description("Can return `null` if there is no Floor Ask"),
            topBidValue: JoiPrice.allow(null).description("Can return `null` if there are no bids"),
            totalBidValue: JoiPrice.allow(null).description("Can return `null` if there are no bids"),
          }),
        })
      ),
