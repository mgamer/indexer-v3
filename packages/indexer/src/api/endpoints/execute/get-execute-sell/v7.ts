    ...
    try {
      ...
      for (const item of items) {
        ...
        if (item.orderId) {
          ...
          if (["seaport-partial", "seaport-v1.3-partial"].includes(result.kind)) {
          ...
          if (
            ["x2y2", "seaport", "seaport-v1.3", "seaport-partial", "seaport-v1.3-partial"].includes(
              result.kind
            )
          ) {
            if (
