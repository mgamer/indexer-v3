...
// Seaport v1.3
import * as seaportV13SellToken from "@/orderbook/orders/seaport-v1.3/build/sell/token";
import * as seaportV13Check from "@/orderbook/orders/seaport-v1.3/check";
      ...
      params: Joi.array().items(
        Joi.object({
          ...
          orderKind: Joi.string()
            ...
            .description("Exchange protocol used to create order. Example: `seaport-v1.3`"),
          ...
          try {
            switch (params.orderKind) {
              ...
              case "seaport-v1.3": {
                ...
                const order = await seaportV13SellToken.build({
                  ...params,
                ...
                // Check the order's fillability
                try {
                  await seaportV13Check.offChainCheck(order, { onChainApprovalRecheck: true });
                } catch (error: any) {
                  switch (error.message) {
                    case "no-balance-no-approval":
                    case "no-balance": {
