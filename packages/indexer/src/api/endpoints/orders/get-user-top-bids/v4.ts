  ...
  handler: async (request: Request) => {
    ...
    try {
      ...
      const baseQuery = `
        ...
        LEFT JOIN LATERAL (
            SELECT t.token_id, t.image_version_updated_at, t.name, t.image, t.collection_id, t.floor_sell_value AS "token_floor_sell_value", t.last_sell_value AS "token_last_sell_value", o.currency AS "token_floor_sell_currency", o.currency_price AS "token_floor_sell_currency_price"
            FROM tokens t
