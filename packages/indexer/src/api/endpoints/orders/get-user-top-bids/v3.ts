  ...
  handler: async (request: Request) => {
    ...
    try {
      ...
      const baseQuery = `
        ...
        LEFT JOIN LATERAL (
            SELECT t.token_id, t.image_version_updated_at, t.name, t.image, t.collection_id, floor_sell_value AS "token_floor_sell_value", last_sell_value AS "token_last_sell_value"
            FROM tokens t
