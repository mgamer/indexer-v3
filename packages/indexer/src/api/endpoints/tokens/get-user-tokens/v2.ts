    ...
    try {
      const baseQuery = `
        SELECT b.contract, b.token_id, b.token_count, b.acquired_at, t.name,
               t.image, t.image_version_updated_at, t.collection_id, b.floor_sell_id, b.floor_sell_value, t.top_buy_id,
        ...
        FROM (
          ...
          JOIN LATERAL (
            SELECT t.token_id, t.image_version_updated_at, t.name, t.image, t.collection_id,
