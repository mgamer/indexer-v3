...
describe("SeaportV13 - ContractWide ERC1155", () => {
  ...
  it("Build and fill buy order", async () => {
    ...
    await weth.approve(seller, SeaportV13.Addresses.Exchange[chainId]);
    ...
    const builder = new SeaportV13.Builders.ContractWide(chainId);
