...
describe("SeaportV11 - SingleToken Erc721", () => {
  ...
  it("Build and fill sell order", async () => {
    ...
    await nft.approve(seller, SeaportV11.Addresses.Exchange[chainId]);
  ...
  it("Build and fill ERC20 sell order", async () => {
    ...
    // Approve the exchange
    await erc20.connect(buyer).approve(SeaportV11.Addresses.Exchange[chainId], price);
