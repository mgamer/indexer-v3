...
describe("SeaportV15 - SingleToken Erc721", () => {
  ...
  it("Build and fill buy order", async () => {
    ...
    // console.log({
    //   buyerWethBalanceAfter: buyerWethBalanceAfter.toString(),
    //   buyerWethBalanceBefore: buyerWethBalanceBefore.toString(),
    //   spend: buyerWethBalanceAfter.sub(buyerWethBalanceBefore).toString(),
    //   get: sellerWethBalanceAfter.sub(sellerWethBalanceBefore).toString(),
    //   fillPrice: fillPrice.toString()
    // })

    expect(sellerWethBalanceAfter.sub(sellerWethBalanceBefore)).to.eq(fillPrice);
    expect(ownerAfter).to.eq(buyer.address);
  });
});
