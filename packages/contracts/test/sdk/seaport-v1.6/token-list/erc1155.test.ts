...
describe("SeaportV16 - TokenList ERC1155", () => {
  ...
  it("Build and fill buy order with partial filling", async () => {
    ...
    await weth.approve(seller1, SeaportV16.Addresses.Exchange[chainId]);
    await weth.approve(seller2, SeaportV16.Addresses.Exchange[chainId]);
    ...
    await nft.approve(seller1, SeaportV16.Addresses.Exchange[chainId]);
    await nft.approve(seller2, SeaportV16.Addresses.Exchange[chainId]);
