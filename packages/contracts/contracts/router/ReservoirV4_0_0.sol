...
contract ReservoirV4_0_0 is Ownable, ReentrancyGuard {
  ...
  function singleERC721ListingFillWithPrecheck(
    ...
    if (expectedOwner != address(0)) {
      require(IERC721(collection).ownerOf(tokenId) == expectedOwner, "Unexpected owner");
    }
  ...
  function onERC721Received(
    ...
    require(selector == this.singleERC721BidFill.selector, "Wrong selector");
  ...
  function onERC1155Received(
    ...
    bytes4 selector = bytes4(data[:4]);
    require(selector == this.singleERC1155BidFill.selector, "Wrong selector");
